...
/*
Desarrolla un programa que averigüe cuantas asignaturas
tiene aprobadas un alumno. El programa debe leer un String
con el nombre de las asignaturas y después otro String con la
lista de sus notas. Debe dar como resultado el nombre de las
asignaturas aprobadas. Tanto la lista de asignaturas como la
