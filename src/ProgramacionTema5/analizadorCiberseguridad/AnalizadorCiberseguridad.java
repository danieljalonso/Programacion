...
public class AnalizadorCiberseguridad {
    ...
    public static void main(String[] args) {
        ...
        Set<String> niveles = new HashSet<>(nivelRiesgoZona.values());
        for (String n : nivelRiesgoZona.values()) {
            reporteRiesgo.put(n, new ArrayList<>());
        }
        for (Log l : logsUnicos) {
            String ubi = l.ubicacion;
            String nivel = nivelRiesgoZona.getOrDefault(l.ubicacion, "BAJO");

            reporteRiesgo.get(nivel).add(l);
        }
